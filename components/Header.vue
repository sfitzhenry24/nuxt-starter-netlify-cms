      ...
      >
        ...
        >
          ...
          <div class="flex items-center space-x-8">
            ...
            <a
              href="https://www.instagram.com/tfitz937/"
              target="_blank"
            ...
            <a
              href="https://www.pinterest.com/tamifitz27/_saved/"
              target="_blank"
              class="text-gray-400 hover:text-gray-300"
            >
          ...
          <div class="bg-white divide-y-2 rounded-lg shadow-xs divide-gray-50">
            ...
            <div class="px-5 py-6 space-y-6">
              ...
              <div class="space-y-6">
                ...
                >
                  <a href="mailto: tcfitzhenry1@gmail.com"> </a>
                  <a
                    href="https://twitter.com/sfitzhenry24"
                    target="_blank"
                    class="text-gray-400 hover:text-gray-300"
                  >
